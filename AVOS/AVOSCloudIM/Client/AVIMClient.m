...
+ (void)initialize
{
    ...
    if (self == [AVIMClient self]) {
        ...
        // conversation updated key should equal to conversation's property name.
        ...
        assert([keyPath(conv, lastReadAt) isEqualToString:AVIMConversationCacheKeyLastReadAt]);
